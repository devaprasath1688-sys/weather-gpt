...
export function LandingPage({
  ...
  return (
    <div className="min-h-screen bg-atmosphere text-slate-100 selection:bg-sky-500 selection:text-slate-950 flex flex-col font-sans">
        ...
        <nav className="mx-auto flex max-w-6xl items-center justify-between rounded-2xl border border-white/[0.06] bg-[#07111e]/60 px-4 py-2.5 backdrop-blur-2xl shadow-[0_8px_32px_-8px_rgba(2,6,23,0.6)] transition-all duration-300 sm:px-6">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex items-center gap-2">
              <span className="text-lg font-bold tracking-tight text-white" style={{ letterSpacing: "-0.03em" }}>
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <Reveal variant="up" delay={1}>
            <div className="space-y-5">
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-white leading-[1.08]" style={{ letterSpacing: "-0.035em" }}>
                Precision Climate Intelligence.<br />
                <span className="text-gradient-cyan">Grounded in Live Telemetry &amp; Truth.</span>
              </h1>
              <p className="max-w-3xl mx-auto text-base sm:text-lg text-slate-300/80 leading-relaxed font-sans" style={{ letterSpacing: "-0.01em" }}>
      ...
      {/* ===================================================================== */}
      <section id="telemetry-strip" className="border-y border-white/[0.04] bg-[#07111e]/40 py-5 overflow-hidden scroll-mt-24">
      ...
      <section id="capabilities" className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-12 scroll-mt-24">
        <Reveal>
          <div className="text-center max-w-2xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white" style={{ letterSpacing: "-0.03em" }}>
              Engineered to Eliminate Misinformation
            </h2>
            <p className="text-sm sm:text-base text-slate-400 leading-relaxed" style={{ letterSpacing: "-0.01em" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Reveal delay={1}>
            <div className="group glass-sheen rounded-2xl p-7 space-y-4 hover-elevate hover:border-sky-500/20 transition-all duration-300 h-full">
              ...
              <h3 className="text-lg font-bold text-white tracking-tight" style={{ letterSpacing: "-0.02em" }}>
                Live Weather Intelligence
              </h3>
              <p className="text-sm text-slate-400 leading-relaxed" style={{ letterSpacing: "-0.01em" }}>
      ...
      {/* ===================================================================== */}
      <section id="how-it-works" className="py-24 bg-[#07111e]/30 border-y border-white/[0.04] px-4 sm:px-6 lg:px-8 scroll-mt-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs font-mono">
            <Reveal delay={1}>
              <div className="glass rounded-2xl p-5 space-y-2 hover-border-glow h-full">
                ...
                <p className="text-slate-300 font-sans text-xs leading-relaxed">Occupation, district coordinate pin, and hazard alert thresholds.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={2}>
              <div className="glass rounded-2xl p-5 space-y-2 hover-border-glow h-full">
                ...
                <p className="text-slate-300 font-sans text-xs leading-relaxed">High-resolution Open-Meteo multi-variable atmospheric telemetry.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={3}>
              <div className="glass rounded-2xl p-5 space-y-2 hover-border-glow h-full">
                ...
                <p className="text-slate-300 font-sans text-xs leading-relaxed">Deterministic 4-vector mathematical calculation (rain, heat, wind, UV).</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={4}>
              <div className="glass rounded-2xl p-5 space-y-2 hover-border-glow h-full">
                ...
                <p className="text-slate-300 font-sans text-xs leading-relaxed">Subdivision flood vulnerability &amp; local disaster control mapping.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={1}>
              <div className="glass rounded-2xl p-5 space-y-2 hover-border-glow h-full">
                ...
                <p className="text-slate-300 font-sans text-xs leading-relaxed">Whitelist-validated Collectorate and IMD administrative bulletins.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={2}>
              <div className="glass rounded-2xl p-5 space-y-2 hover-border-glow h-full">
                ...
                <p className="text-slate-300 font-sans text-xs leading-relaxed">Action directives and routine guidelines in English and Tamil.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={3}>
              <div className="col-span-1 sm:col-span-2 glass-strong rounded-2xl p-5 space-y-2 border-sky-500/20">
                ...
                <p className="text-slate-200 font-sans text-xs leading-relaxed">Delivered directly via interactive dashboard with 100% telemetry relevance and zero fatigue.</p>
              </div>
            </Reveal>
          </div>
        </div>
        ...
        <Reveal>
          <div className="glass-elevated rounded-3xl p-8 sm:p-12 space-y-8">
            <div className="max-w-3xl space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-white" style={{ letterSpacing: "-0.03em" }}>
                AI Informs. Authorities Decide.
              </h2>
              <p className="text-sm sm:text-base text-slate-300 leading-relaxed" style={{ letterSpacing: "-0.01em" }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
              <Reveal delay={1}>
                <div className="glass rounded-xl p-5 space-y-2 hover-border-glow h-full">
                  <span className="font-mono font-bold text-lg text-sky-400/30">01</span>
              ...
              <Reveal delay={2}>
                <div className="glass rounded-xl p-5 space-y-2 hover-border-glow h-full">
                  <span className="font-mono font-bold text-lg text-sky-400/30">02</span>
              ...
              <Reveal delay={3}>
                <div className="glass rounded-xl p-5 space-y-2 hover-border-glow h-full">
                  <span className="font-mono font-bold text-lg text-sky-400/30">03</span>
              ...
              <Reveal delay={4}>
                <div className="glass rounded-xl p-5 space-y-2 hover-border-glow h-full">
                  <span className="font-mono font-bold text-lg text-sky-400/30">04</span>
