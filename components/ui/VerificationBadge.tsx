...
export function VerificationBadge({
  ...
  if (status === "verified_official") {
    return (
      ...
      >
        ...
        <span className="text-white font-bold">{t("common.verifiedOfficial")}</span>
  ...
  if (status === "expired") {
    return (
      ...
      >
        ...
        <span>{t("common.expiredBulletin")}</span>
      </div>
    );
  }
  ...
  if (status === "pending_review") {
    return (
      ...
      >
        ...
        <span>{t("common.pendingVerification")}</span>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <span>{t("common.unverifiedStream")}</span>
    </div>
  );
}
