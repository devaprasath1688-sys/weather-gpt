...
export default function HomePage() {
  ...
  // Clean monochrome severity badge
  ...
  return (
    ...
    >
      {/* ========================================================================= */}
      {/* TAB 1: OVERVIEW (Exact Order Prescribed in Part 5)                          */}
      {/* ========================================================================= */}
      {activeTab === "overview" && (
        <div className="space-y-10">
          {/* Part 6: Centered Hero */}
          <div className="text-center max-w-3xl mx-auto space-y-3 pt-2 pb-2">
            <div className="inline-flex items-center gap-2 rounded-full border border-neutral-800 bg-neutral-900 px-3 py-1 text-xs font-mono font-medium text-neutral-300">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight">
              ...
              <span className="text-neutral-400">Zero Announcement Fatigue.</span>
            </h1>
          ...
          <section className="space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              ...
              <div className="flex items-center gap-2 text-[11px] font-mono text-neutral-400">
                <span>Source: <strong className="text-neutral-200">{liveWeather?.metadata?.providerName || "Open-Meteo High-Res Engine"}</strong></span>
                <span>•</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 text-xs">
              {/* Temperature */}
              <div className="rounded-xl border border-neutral-800 bg-neutral-900/80 p-3.5 space-y-1">
                ...
                <span className="text-[10px] text-neutral-500 block">Ambient dry-bulb</span>
              </div>
              ...
              <div className="rounded-xl border border-neutral-800 bg-neutral-900/80 p-3.5 space-y-1">
                ...
                <span className="text-[10px] text-neutral-500 block">Heat index load</span>
              </div>
              ...
              <div className="rounded-xl border border-neutral-800 bg-neutral-900/80 p-3.5 space-y-1">
                <div className="flex items-center justify-between text-neutral-400">
                  ...
                  <CloudRain className="h-3.5 w-3.5 text-neutral-400" />
                </div>
                <p className="text-xl font-extrabold text-white font-mono">
                  {activeWeather.rainfallMm24h} <span className="text-xs text-neutral-400 font-normal">mm</span>
                </p>
                <span className="text-[10px] text-neutral-500 block">Precipitation depth</span>
              </div>
              ...
              <div className="rounded-xl border border-neutral-800 bg-neutral-900/80 p-3.5 space-y-1">
                ...
                <p className="text-xl font-extrabold text-white font-mono">
                  {activeWeather.windSpeedKmh} <span className="text-xs text-neutral-400 font-normal">km/h</span>
                </p>
                <span className="text-[10px] text-neutral-500 block">Surface velocity</span>
              </div>
              ...
              <div className="rounded-xl border border-neutral-800 bg-neutral-900/80 p-3.5 space-y-1">
                ...
                <span className="text-[10px] text-neutral-500 block">Relative vapor</span>
              </div>
              ...
              <div className="rounded-xl border border-neutral-800 bg-neutral-900/80 p-3.5 space-y-1">
                ...
                <p className="text-xl font-extrabold text-white font-mono">
                  {activeWeather.uvIndex} <span className="text-xs text-neutral-400 font-normal">/ 11</span>
                </p>
                <span className="text-[10px] text-neutral-500 block">Solar radiation</span>
              </div>

              {/* Weather Condition */}
              <div className="col-span-2 sm:col-span-2 lg:col-span-1 rounded-xl border border-neutral-800 bg-neutral-900/80 p-3.5 space-y-1">
                <div className="flex items-center justify-between text-neutral-400">
                ...
                <span className="text-[10px] text-neutral-500 block capitalize">{activeWeather.conditionCategory.replace("_", " ")}</span>
              </div>
            </div>
          </section>

          {/* ===================================================================== */}
          {/* 3. LOCATION & ENVIRONMENTAL CONTEXT (Part 9)                         */}
          {/* ===================================================================== */}
          <section className="space-y-3">
            <div className="flex items-center gap-2">
              <span className="font-mono text-xs font-bold text-neutral-500 uppercase tracking-wider">
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-5 sm:p-6 shadow-sm space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
                {/* District Switcher */}
                <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-3.5 space-y-2">
                  <span className="text-[10px] uppercase font-mono text-neutral-500 block font-semibold">
                    District &amp; State
                  </span>
                  <select
                    ...
                    className="w-full bg-neutral-900 border border-neutral-700 rounded-lg px-2.5 py-1.5 text-xs font-bold text-white focus:border-white focus:outline-none"
                  >
                ...
                <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-3.5 space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-neutral-900 border border-neutral-700 rounded-lg px-2.5 py-1.5 text-xs font-bold text-white capitalize focus:border-white focus:outline-none"
                  >
                    {OCCUPATION_KEYS.map((occ) => (
                      <option key={occ} value={occ} className="bg-neutral-900 text-white capitalize">
                        {occ}
                      </option>
                    ))}
                  </select>
          ...
          <section className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="rounded-full border border-neutral-700 bg-neutral-950 px-2.5 py-0.5 text-xs font-bold font-mono text-white">
                {riskLabel}
              </span>
            </div>

            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-5 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-2">
                <div>
                  <span className="text-xs font-semibold text-neutral-400 uppercase font-mono block">
                ...
                <div className="text-right">
                  ...
                  <span className="text-sm text-neutral-500 font-normal font-mono"> / 100</span>
                </div>
              </div>

              {/* Neutral High-Contrast Progress Track */}
              <div className="h-2.5 w-full overflow-hidden rounded-full bg-neutral-950 border border-neutral-800">
                <div
              ...
              {/* Rationale Box */}
              <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1 text-xs">
                <span className="text-neutral-200 font-bold block">Why this risk score exists:</span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-xs font-mono">
                <div className="bg-neutral-950 border border-neutral-800 p-3 rounded-xl text-center space-y-1">
                  <span className="text-[10px] text-neutral-500 uppercase block">Rain Risk</span>
                  <span className="text-base font-bold text-white">{riskAnalysis.subScores.rainRisk}/100</span>
                  <div className="h-1 w-full bg-neutral-900 rounded-full overflow-hidden">
                    <div className="h-full bg-white" style={{ width: `${riskAnalysis.subScores.rainRisk}%` }} />
                  </div>
                </div>

                <div className="bg-neutral-950 border border-neutral-800 p-3 rounded-xl text-center space-y-1">
                  <span className="text-[10px] text-neutral-500 uppercase block">Solar UV</span>
                  <span className="text-base font-bold text-white">{riskAnalysis.subScores.uvRisk}/100</span>
                  <div className="h-1 w-full bg-neutral-900 rounded-full overflow-hidden">
                    <div className="h-full bg-white" style={{ width: `${riskAnalysis.subScores.uvRisk}%` }} />
                  </div>
                </div>

                <div className="bg-neutral-950 border border-neutral-800 p-3 rounded-xl text-center space-y-1">
                  <span className="text-[10px] text-neutral-500 uppercase block">Wind Risk</span>
                  <span className="text-base font-bold text-white">{riskAnalysis.subScores.windRisk}/100</span>
                  <div className="h-1 w-full bg-neutral-900 rounded-full overflow-hidden">
                    <div className="h-full bg-white" style={{ width: `${riskAnalysis.subScores.windRisk}%` }} />
                  </div>
                </div>

                <div className="bg-neutral-950 border border-neutral-800 p-3 rounded-xl text-center space-y-1">
                  <span className="text-[10px] text-neutral-500 uppercase block">Heat Risk</span>
                  <span className="text-base font-bold text-white">{riskAnalysis.subScores.heatRisk}/100</span>
                  <div className="h-1 w-full bg-neutral-900 rounded-full overflow-hidden">
                    <div className="h-full bg-white" style={{ width: `${riskAnalysis.subScores.heatRisk}%` }} />
                  </div>
                </div>

                <div className="col-span-2 sm:col-span-1 bg-neutral-950 border border-neutral-800 p-3 rounded-xl text-center space-y-1">
                  <span className="text-[10px] text-neutral-500 uppercase block">Travel Risk</span>
                  <span className="text-base font-bold text-white">{Math.round((riskAnalysis.subScores.rainRisk + riskAnalysis.subScores.windRisk) / 2)}/100</span>
                  <div className="h-1 w-full bg-neutral-900 rounded-full overflow-hidden">
                    <div className="h-full bg-white" style={{ width: `${Math.round((riskAnalysis.subScores.rainRisk + riskAnalysis.subScores.windRisk) / 2)}%` }} />
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono uppercase bg-neutral-950 text-neutral-300 border border-neutral-700 px-2.5 py-0.5 rounded-full">
                {activeAlerts.length > 0 ? `${activeAlerts.length} Active Bulletin` : "Verified Normal"}
              </span>
            </div>

            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-4 shadow-sm">
              {activeAlerts.length > 0 ? (
                <div className="space-y-3">
                  {activeAlerts.map((alert) => (
                    <div key={alert.id} className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-2 text-xs">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-white text-sm">{alert.title}</span>
                        <span className="text-[10px] font-mono uppercase bg-neutral-900 text-neutral-200 border border-neutral-700 px-2 py-0.5 rounded-full">
                          {alert.severity}
                        </span>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-neutral-800/80 text-[10px] text-neutral-400">
                        ...
                        {alert.officialRefUrl && (
                          <a
                            ...
                            className="inline-flex items-center gap-1 text-white hover:underline font-mono"
                          >
          ...
          <section className="space-y-3">
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-4 shadow-sm">
              <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1.5 text-xs">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  {riskAnalysis.recommendedPrecautions.map((prec, i) => (
                    <div key={i} className="flex items-start gap-2.5 rounded-xl border border-neutral-800 bg-neutral-950 p-3 text-neutral-300">
          ...
          <section className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono font-bold uppercase text-white bg-neutral-950 border border-neutral-700 px-2.5 py-0.5 rounded-full">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="space-y-1.5">
                  {recommendation.safetyActions.en.map((action, i) => (
                    <div key={i} className="flex items-start gap-2.5 rounded-xl border border-neutral-800 bg-neutral-950 p-3 text-neutral-200">
                      <span className="font-mono font-bold text-white">0{i + 1}.</span>
                      <span>{action}</span>
                    </div>
                  ))}
                </div>
          ...
          {/* ===================================================================== */}
          {/* 8. DISTRICT INTELLIGENCE (Part 14)                                   */}
          {/* ===================================================================== */}
          <section className="space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 text-xs font-mono">
                <span className="text-neutral-400">Dominant Hazard:</span>
                <span className="text-white font-bold">{districtIntel.dominantHazard}</span>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-4 shadow-sm">
              <div className="grid gap-3 sm:grid-cols-3 text-xs">
                {districtIntel.affectedAreas.map((area) => (
                  <div key={area.name} className="rounded-xl border border-neutral-800 bg-neutral-950 p-3.5 space-y-1.5">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-white">{area.name}</span>
                      <span className="text-[10px] font-mono font-bold uppercase px-2 py-0.5 rounded-full border border-neutral-700 bg-neutral-900 text-neutral-200">
                        {area.waterloggingRisk}
                      </span>
                    </div>
                    <span className="text-[10px] text-neutral-500 font-mono block">{area.subdivision}</span>
                    <p className="text-neutral-400 text-[11px] leading-relaxed">{area.disruptionLevel}</p>
                  </div>
                ))}
              </div>

              <div className="flex flex-wrap gap-4 text-xs font-mono text-neutral-400 pt-2 border-t border-neutral-800">
                <span>District Helpline: <strong className="text-white">{districtIntel.emergencyContacts.helpline}</strong></span>
          ...
          {/* ===================================================================== */}
          {/* 9. RIGHT INFORMATION. RIGHT USER. (Part 15)                          */}
          {/* ===================================================================== */}
          <section className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 sm:p-8 space-y-6 shadow-sm">
            <div className="max-w-3xl space-y-2 text-center mx-auto">
              <div className="inline-flex items-center gap-2 rounded-full border border-neutral-700 bg-neutral-950 px-3 py-1 text-xs font-semibold text-neutral-300">
            ...
            <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 text-xs">
              <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1.5">
                <span className="font-mono text-[10px] uppercase text-neutral-500 font-semibold">01 · Ground Truth</span>
                <p className="font-bold text-white text-sm">Verified Official Sources</p>
                <p className="text-[11px] text-neutral-400">Untouched District Collectorate and IMD bulletins.</p>
              </div>

              <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1.5">
                <span className="font-mono text-[10px] uppercase text-neutral-500 font-semibold">02 · Verification</span>
                <p className="font-bold text-white text-sm">AI Fact Extraction</p>
                <p className="text-[11px] text-neutral-400">Strict fact extraction with zero hallucinated emergency orders.</p>
              </div>

              <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1.5">
                <span className="font-mono text-[10px] uppercase text-neutral-500 font-semibold">03 · Tailored</span>
                <p className="font-bold text-white text-sm">Personalized For You</p>
                <p className="text-[11px] text-neutral-400">Targeted to your occupation, transit routine, and district.</p>
              </div>

              <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1.5">
                <span className="font-mono text-[10px] uppercase text-neutral-500 font-semibold">04 · Zero Fatigue</span>
                <p className="font-bold text-white text-sm">Actionable Intelligence</p>
                <p className="text-[11px] text-neutral-400">Clear safety directives while suppressing irrelevant district spam.</p>
              </div>
            </div>
          </section>
        </div>
      ...
      {/* ========================================================================= */}
      {/* TAB 2: LIVE WEATHER (Deep-Dive Meteorological Telemetry)                  */}
      {/* ========================================================================= */}
      {activeTab === "weather" && (
        <div className="space-y-8">
          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-3">
              <div className="flex items-center justify-between text-neutral-400">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-neutral-400 font-mono">Feels like {activeWeather.feelsLikeC}°C</p>
              </div>
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-neutral-400 font-mono">Relative Humidity: {activeWeather.humidityPercent}%</p>
              </div>
              <div className="pt-3 border-t border-neutral-800 text-[11px] text-neutral-400">
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-neutral-400 font-mono">UV Index: {activeWeather.uvIndex} / 11</p>
              </div>
              <div className="pt-3 border-t border-neutral-800 text-[11px] text-neutral-400">
          ...
          <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-3 text-xs font-mono">
              <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1">
                <span className="text-neutral-500 uppercase text-[10px] block">Latitude</span>
                <span className="font-bold text-white text-sm">{activeProfile.latitude.toFixed(4)}°N</span>
              </div>
              <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1">
                <span className="text-neutral-500 uppercase text-[10px] block">Longitude</span>
                <span className="font-bold text-white text-sm">{activeProfile.longitude.toFixed(4)}°E</span>
              </div>
              <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1">
                <span className="text-neutral-500 uppercase text-[10px] block">Provider</span>
              ...
              <div className="space-y-3 text-xs">
                <div className="space-y-1">
                  <div className="flex justify-between font-mono">
                    <span className="text-neutral-400">Precipitation Inundation Hazard</span>
                    <span className="text-white font-bold">{riskAnalysis.subScores.rainRisk}/100</span>
                  </div>
                  <div className="h-2 w-full bg-neutral-950 rounded-full overflow-hidden border border-neutral-800">
                    <div className="h-full bg-white rounded-full" style={{ width: `${riskAnalysis.subScores.rainRisk}%` }} />
                  </div>
                </div>

                <div className="space-y-1">
                  <div className="flex justify-between font-mono">
                    <span className="text-neutral-400">Thermal Heat Stress Load</span>
                    <span className="text-white font-bold">{riskAnalysis.subScores.heatRisk}/100</span>
                  </div>
                  <div className="h-2 w-full bg-neutral-950 rounded-full overflow-hidden border border-neutral-800">
                    <div className="h-full bg-white rounded-full" style={{ width: `${riskAnalysis.subScores.heatRisk}%` }} />
                  </div>
                </div>

                <div className="space-y-1">
                  <div className="flex justify-between font-mono">
                    <span className="text-neutral-400">Wind Velocity Impact</span>
                    <span className="text-white font-bold">{riskAnalysis.subScores.windRisk}/100</span>
                  </div>
                  <div className="h-2 w-full bg-neutral-950 rounded-full overflow-hidden border border-neutral-800">
                    <div className="h-full bg-white rounded-full" style={{ width: `${riskAnalysis.subScores.windRisk}%` }} />
                  </div>
                </div>

                <div className="space-y-1">
                  <div className="flex justify-between font-mono">
                    <span className="text-neutral-400">Solar UV Radiation Exposure</span>
                    <span className="text-white font-bold">{riskAnalysis.subScores.uvRisk}/100</span>
                  </div>
                  <div className="h-2 w-full bg-neutral-950 rounded-full overflow-hidden border border-neutral-800">
                    <div className="h-full bg-white rounded-full" style={{ width: `${riskAnalysis.subScores.uvRisk}%` }} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-4">
              ...
              <div className="space-y-3 text-xs">
                <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-1.5">
                  ...
                  <p className="text-neutral-300 leading-relaxed">{riskAnalysis.occupationImpact}</p>
                </div>
                <div className="space-y-2">
                  <span className="text-[10px] font-mono uppercase text-neutral-500 block">Standard Precautions</span>
          ...
          <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-4">
            ...
            {activeAlerts.length > 0 ? (
              <div className="space-y-4">
                {activeAlerts.map((alert) => (
                  <div key={alert.id} className="rounded-xl border border-neutral-800 bg-neutral-950 p-5 space-y-3 text-xs">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-white text-sm">{alert.title}</span>
                      <span className="text-[10px] font-mono uppercase bg-neutral-900 text-neutral-200 border border-neutral-700 px-2.5 py-0.5 rounded-full">
                        {alert.severity}
                      </span>
                    </div>
                    <div className="rounded-lg bg-neutral-900 p-3 font-mono text-neutral-300 text-[11px] leading-relaxed border border-neutral-800">
                      &quot;{alert.rawAnnouncement}&quot;
                    </div>
                    <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-neutral-800/80 text-[11px] text-neutral-400">
      ...
      {activeTab === "recommendations" && (
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 sm:p-8 space-y-6">
            <div className="space-y-2">
              ...
              {recommendation.primaryDirective.ta && (
                <p className="text-xs sm:text-sm text-neutral-400 pt-2 border-t border-neutral-800">
                  தமிழ்: {recommendation.primaryDirective.ta}
                </p>
              )}
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="space-y-2">
                {recommendation.safetyActions.en.map((action, i) => (
                  <div key={i} className="flex items-start gap-3 rounded-xl border border-neutral-800 bg-neutral-950 p-3.5 text-xs text-neutral-200">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-neutral-800 text-xs font-mono text-neutral-400">
              <span>Severity Classification: <strong className="text-white uppercase">{recommendation.severity}</strong></span>
      ...
      {/* ========================================================================= */}
      {/* TAB 6: DISTRICT INTELLIGENCE (Part 20)                                    */}
      {/* ========================================================================= */}
      {activeTab === "district" && (
        <div className="space-y-8">
          <div className="space-y-2 border-b border-neutral-800 pb-4">
          ...
          <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-neutral-800 pb-3 gap-2">
              <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono text-neutral-400">
                Dominant Hazard: <strong className="text-white">{districtIntel.dominantHazard}</strong>
              </span>
            </div>

            <div className="grid gap-4 sm:grid-cols-3 text-xs">
              {districtIntel.affectedAreas.map((area) => (
                <div key={area.name} className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-white">{area.name}</span>
                    <span className="text-[10px] font-mono font-bold uppercase px-2 py-0.5 rounded-full border border-neutral-700 bg-neutral-900 text-neutral-200">
                      {area.waterloggingRisk}
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-4 space-y-2 text-xs font-mono">
              <span className="text-neutral-500 uppercase text-[10px] block">Emergency Control Network</span>
              <div className="flex flex-wrap gap-6 text-neutral-300">
                <span>District Disaster Helpline: <strong className="text-white">{districtIntel.emergencyContacts.helpline}</strong></span>
                <span>Collectorate Control Room: <strong className="text-white">{districtIntel.emergencyContacts.controlRoom}</strong></span>
              </div>
            </div>
          </div>
        </div>
      ...
      {activeTab === "pipeline" && (
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 sm:p-8 space-y-8">
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 sm:p-8 space-y-6">
            <div className="rounded-xl border border-neutral-800 bg-neutral-950 p-5 space-y-2">
              <span className="text-[10px] font-mono uppercase text-neutral-500 font-semibold block">Separation of Concerns Principle</span>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {CORE_DIFFERENTIATORS.map((diff, index) => (
                <div
                  key={diff}
                  className="rounded-xl border border-neutral-800 bg-neutral-950 p-5 flex flex-col justify-between space-y-3"
                >
                  <span className="font-mono font-bold text-xl text-neutral-600">
                    0{index + 1}
                  </span>
                  <h3 className="font-semibold text-xs text-neutral-200 leading-snug">
                    {diff}
                  </h3>
                  <div className="pt-2 border-t border-neutral-800 flex items-center gap-1.5 text-[10px] text-neutral-400 font-mono">
